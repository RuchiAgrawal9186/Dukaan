  ...
  return (
    ...
    <div className='leftcontainer'>
        <div style={{display:"flex",gap:"10px"}}>
            ...
            <div>
                <img src="./images/Chevron Down.png" alt=""  style={{width:"100%"}}/>
            </div>
        </div>
        ...
        <div className='iconscontainer'>
            <div><img src="./images/Navbar Icon9.png" alt="" /></div>
            <div> <p>Appearance</p></div>
           
        </div>

        <div className='iconscontainer'>
            <div><img src="./images/Navbar Icon10.png" alt="" /></div>
            <div><p>Plugins</p></div>
        ...
        <div style={{display:"flex",gap:"10px"}} className='btmnav'>
            <div><img src="./images/wallet.svg" alt="" /></div>
            <div style={{display:"flex",flexDirection:"column"}}>
